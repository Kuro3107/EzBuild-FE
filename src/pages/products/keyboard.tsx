...
function KeyboardPage() {
  ...
  const allKeyboards = [
    {
      ...
      features: ['Optical Switches', 'RGB Lighting', 'iCUE Software', 'Gaming', 'Premium Build'],
      rating: 4.7,
      reviews: 342,
      inStock: true
    },
    {
      ...
      features: ['Mechanical Switches', 'RGB Lighting', 'Razer Synapse', 'Gaming', 'Command Dial'],
      rating: 4.6,
      reviews: 289,
      inStock: true
    },
    {
      ...
      features: ['Wireless', 'Low-profile', 'RGB Lighting', 'Gaming', 'Long Battery Life'],
      rating: 4.5,
      reviews: 156,
      inStock: true
    },
    {
      ...
      features: ['Adjustable Actuation', 'RGB Lighting', 'SteelSeries Engine', 'Gaming', 'OLED Display'],
      rating: 4.8,
      reviews: 203,
      inStock: false
    },
    {
      ...
      features: ['Wireless', 'Mac Compatible', 'Hot-swappable', 'Budget Friendly', 'PBT Keycaps'],
      rating: 4.4,
      reviews: 178,
      inStock: true
    },
    {
      ...
      features: ['96% Layout', 'RGB Lighting', 'Armoury Crate', 'Gaming', 'Hot-swappable'],
      rating: 4.6,
      reviews: 145,
      inStock: true
    }
  ...
  const filteredKeyboards = allKeyboards.filter((keyboardItem) => {
    // Price filter
    if (keyboardItem.price < priceRange[0] || keyboardItem.price > priceRange[1]) {
      return false
    }
                ...
                {filteredKeyboards.map((keyboardItem) => (
                  <div key={keyboardItem.id} className="rounded-lg border border-black/10 bg-white hover:bg-black/5 transition cursor-pointer" onClick={() => setSelectedKeyboard(keyboardItem)}>
                    <div className="p-4">
                      ...
                      <div className="text-lg font-bold mb-3">${keyboardItem.price}</div>
